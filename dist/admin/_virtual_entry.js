...
import { FocusModal, Button, Container, Heading, DropdownMenu, IconButton } from '@medusajs/ui';
import { CheckCircleSolid, EllipsisHorizontal, PencilSquare } from '@medusajs/icons';
import { useMedusa, useAdminUpdateVariant, useAdminUpdateProduct } from 'medusa-react';
...
function nestedForm(form, path) {
  return __spreadProps(__spreadValues({}, form), {
    ...
    get(obj, field) {
      ...
      return fullPath ? lodashExports.get(obj, fullPath) : obj;
    }
  });
}
...
const prepareImages = async (images, uploads) => {
...
const defaultText = /* @__PURE__ */ jsxs("span", { children: [
  "Drop your images here, or",
  " ",
  /* @__PURE__ */ jsx("span", { className: "text-violet-60", children: "click to browse" })
] });
...
const VariantsImagesMediaForm = ({ form, type }) => {
  ...
  const prevSelectedImage = useRef(
    fields == null ? void 0 : fields.findIndex((field) => field.selected)
  );
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    fields.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-large", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-small", children: [
        /* @__PURE__ */ jsx("h2", { className: "inter-large-semibold mb-2xsmall", children: "Uploads" }),
        /* @__PURE__ */ jsx("p", { className: "inter-base-regular text-grey-50 mb-large", children: type === "thumbnail" ? /* @__PURE__ */ jsx("span", { children: "Select an image to use as variant thumbnail." }) : /* @__PURE__ */ jsx("span", { children: "Select images to use as variant images." }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex flex-wrap space-x-4", children: fields.map((field, index) => {
        return /* @__PURE__ */ jsx(
          Image,
          {
            image: field,
...
const Image = ({ image, index, form, onSelected }) => {
      ...
      render: ({ field: { value, onChange } }) => {
        return /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "gap-x-large flex items-center", children: [
              /* @__PURE__ */ jsx("div", { className: "flex h-32 w-32 items-center justify-center", children: /* @__PURE__ */ jsx(
                "img",
                {
                  src: image.url,
              ...
              /* @__PURE__ */ jsx(
                "span",
                {
                  className: clsx("hidden", {
                    "!text-violet-60 bottom-xsmall right-xsmall absolute !block": value
                  }),
                  children: /* @__PURE__ */ jsx(CheckCircleSolid, {})
                }
              )
            ] })
          }
...
const VariantsImagesModal = ({
  ...
  const adminUpdateVariant = useAdminUpdateVariant(product == null ? void 0 : product.id);
  const adminUpdateProduct = useAdminUpdateProduct(product == null ? void 0 : product.id);
  const form = useForm({
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    if (type === "thumbnail") {
      const thumbnail = ((_a = data.media.images.find((image) => image.selected)) == null ? void 0 : _a.url) || null;
      ...
      const images = data.media.images.map(({ selected }, i) => selected && urls[i]).filter(Boolean);
      await adminUpdateVariant.mutate({
        variant_id: variant.id,
        // @ts-ignore
        images
  ...
  return /* @__PURE__ */ jsx(FocusModal, { open, onOpenChange: onReset, modal: true, children: /* @__PURE__ */ jsxs(FocusModal.Content, { children: [
    ...
    /* @__PURE__ */ jsx(FocusModal.Body, { className: " p-4", children: /* @__PURE__ */ jsx("form", { onSubmit, id: "variant-images-form", children: /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h2", { className: "inter-large-semibold mb-2xsmall", children: "Media" }),
      /* @__PURE__ */ jsx("p", { className: "inter-base-regular text-grey-50 mb-large", children: "Add images to your product media." }),
...
const getDefaultValues = (product, variant, type) => {
  ...
  return {
    media: {
      images: ((_a = product == null ? void 0 : product.images) == null ? void 0 : _a.map((image) => {
        var _a2, _b;
        return {
          url: image.url,
          selected: type === "thumbnail" ? variant.thumbnail === image.url : (_b = (_a2 = variant == null ? void 0 : variant.images) == null ? void 0 : _a2.some((vImage) => vImage.url === image.url)) != null ? _b : false
        };
      })) || []
    }
  };
...
const VariantsImagesWidget = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Container, { title: "Variants Images", children: [
      /* @__PURE__ */ jsx(
        Heading,
        {
          level: "h1",
          className: "flex items-center justify-between gap-x-4 text-2xl font-semibold",
          children: /* @__PURE__ */ jsx("div", { children: "Variants Images" })
        }
      ),
      product.variants.map((variant) => /* @__PURE__ */ jsxs("div", { className: "mt-3 w-full", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center", children: [
          variant.thumbnail ? /* @__PURE__ */ jsx(
            "img",
            {
          ...
          ) : /* @__PURE__ */ jsx("div", { className: "inter-regular mr-1 w-20 break-words", children: "No thumbnail" }),
          variant.images.length ? variant.images.map((image) => /* @__PURE__ */ jsx(
            "img",
            {
              src: image.url,
              alt: "Uploaded image",
            ...
            image.id
          )) : /* @__PURE__ */ jsx("span", { className: "inter-regular", children: "No images..." })
        ] })
      ] }, variant.id))
    ] }),
...
const entry = {
  identifier: "medusa-plugin-variant-images",
  extensions: [
    { Component: VariantsImagesWidget, config: { ...config, type: "widget" } }
  ],
};
